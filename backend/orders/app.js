...
const verifiedDoctorOrderRoutes = require('./routes/verifiedDoctorOrders');
const pickedUpOrdersRoutes = require('./routes/pickedUpOrders');

//Set up mongoose connection
mongoose.connect('mongodb+srv://Renuka:Renuka@cluster0.10ayp.mongodb.net/orderservice',{useNewUrlParser: true , useUnifiedTopology: true})
  .then(()=>{
